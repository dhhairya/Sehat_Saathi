    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)' }}>
      ...
      <div style={{ background:'linear-gradient(135deg, #FF6B9D 0%, #E55A8A 50%, #6B5CE7 100%)', padding:'24px 20px 28px', borderRadius:'0 0 32px 32px', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px' }}>
          ...
          <button onClick={() => { navigate('/'); logout(); }} style={{ width:'40px',height:'40px',borderRadius:'12px',background:'rgba(255,255,255,0.15)',display:'flex',alignItems:'center',justifyContent:'center' }}>
